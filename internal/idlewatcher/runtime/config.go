...
type (
	...
	DockerConfig struct {
		DockerCfg     types.DockerProviderConfig `json:"docker_cfg" validate:"required"`
...
type (
	...
	ConfigBase     = IdlewatcherConfigBase
	ProviderConfig = IdlewatcherProviderConfig
	StopMethod     = ContainerStopMethod
