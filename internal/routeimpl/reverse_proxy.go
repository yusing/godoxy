...
var _ routing.ReverseProxyRoute = (*ReverseProxyRoute)(nil)
...
func NewReverseProxyRoute(base *route.Route) (*ReverseProxyRoute, error) {
...
func (r *ReverseProxyRoute) LoadBalancer() *loadbalancer.LoadBalancer {
...
func (r *ReverseProxyRoute) Start(parent task.Parent) error {
	r.Init(parent, "http."+r.Name(), false)
...
func (r *ReverseProxyRoute) addToLoadBalancer(parent task.Parent, ep routing.Entrypoint) error {
