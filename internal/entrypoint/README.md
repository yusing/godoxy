...
- Benchmark tests in [`entrypoint_benchmark_test.go`](internal/entrypoint/entrypoint_benchmark_test.go) and SNI router benchmark files (`sni_passthrough*_benchmark_test.go`)
