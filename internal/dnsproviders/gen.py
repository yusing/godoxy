...
placeholder_header = """// Code generated by gen.py; DO NOT EDIT.
...
with open("../autocert/provider_placeholders_gen.go", "w") as f:
    f.write(placeholder_header)
    for name in ["local", "pseudo", *allowlist]:
        f.write(f'\t\t"{name}",\n')
    f.write("\t)\n}\n")

os.execvp("gofmt", ["gofmt", "-w", "providers.go", "../autocert/provider_placeholders_gen.go"])
