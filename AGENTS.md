...
- Bun, Vite, TanStack Router/Start — `webui/src/router.tsx`, `webui/src/routes/`, generated `routeTree.gen.ts`.
...
2. `gperr "goutils/errs"` nested errors:
   ...
   - `gperr.PrependSubject()` prepend subject (object name, id, etc.; not error title)
